...
import com.gasmeters.portlet.service.AvailableLocalService;
...
/**
 * Provides the base implementation for the available local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.gasmeters.portlet.service.impl.AvailableLocalServiceImpl}.
 * </p>
 *
 * @author George
 * @see com.gasmeters.portlet.service.impl.AvailableLocalServiceImpl
 * @see com.gasmeters.portlet.service.AvailableLocalServiceUtil
 * @generated
 */
public abstract class AvailableLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements AvailableLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link com.gasmeters.portlet.service.AvailableLocalServiceUtil} to access the available local service.
	 */
	...
	@Override
	public Available addAvailable(Available available)
		throws SystemException {
		available.setNew(true);

		return availablePersistence.update(available);
	}
	 ...
	 */
	@Override
	public Available createAvailable(long serialNums) {
		return availablePersistence.create(serialNums);
	}
	...
	@Override
	public Available deleteAvailable(long serialNums)
		throws PortalException, SystemException {
		return availablePersistence.remove(serialNums);
	}
	...
	@Indexable(type = IndexableType.DELETE)
	@Override
	public Available deleteAvailable(Available available)
		throws SystemException {
		return availablePersistence.remove(available);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(Available.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return availablePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return availablePersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return availablePersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	@Override
	public Available fetchAvailable(long serialNums) throws SystemException {
		return availablePersistence.fetchByPrimaryKey(serialNums);
	}
	 ...
	 */
	@Override
	public Available getAvailable(long serialNums)
		throws PortalException, SystemException {
		return availablePersistence.findByPrimaryKey(serialNums);
	}

	@Override
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return availablePersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public List<Available> getAvailables(int start, int end)
		throws SystemException {
		return availablePersistence.findAll(start, end);
	}
	 ...
	 */
	@Override
	public int getAvailablesCount() throws SystemException {
	...
	@Indexable(type = IndexableType.REINDEX)
	@Override
	public Available updateAvailable(Available available)
		throws SystemException {
		return availablePersistence.update(available);
	}
	...
	public void afterPropertiesSet() {
		...
		PersistedModelLocalServiceRegistryUtil.register("com.gasmeters.portlet.model.Available",
			availableLocalService);
	}
	...
	private AvailableLocalServiceClpInvoker _clpInvoker = new AvailableLocalServiceClpInvoker();
}